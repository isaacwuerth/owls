...
import {
  ParticipantState,
  translationTableColors,
  translationTableEnum,
} from '../../model/enum/ParticipantState'
...
export function ChartParticipantState({
  participants,
}: ChartParticipantStateProps) {
  ...
  const options: ApexOptions = {
    series: [
      countParticipants(participants, ParticipantState.COMMITMENT),
